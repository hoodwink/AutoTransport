...
--alter table PDP.dbo.ResultsData drop CONSTRAINT PK_ResultsData;
alter table PDP.dbo.ResultsData ADD CONSTRAINT PK_ResultsData PRIMARY KEY CLUSTERED (SAMPLE_PK, PESTCODE, PDP_YEAR, COMMOD);

drop index indx_pdp_year on pdp.dbo.ResultsData;
